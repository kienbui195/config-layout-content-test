...
export interface ApiGetLayoutGetLayout extends Schema.SingleType {
  ...
  attributes: {
    ...
    choose_layout: Attribute.Enumeration<['select from exist', 'custom']> &
      Attribute.DefaultTo<'select from exist'>;
    prod_layout: Attribute.Relation<
      'api::get-layout.get-layout',
      'oneToOne',
      'api::prod-layout.prod-layout'
    >;
    prod_layout_custom: Attribute.Component<'options.options'>;
...
export interface ApiProdLayoutProdLayout extends Schema.CollectionType {
  collectionName: 'prod_layouts';
  info: {
    singularName: 'prod-layout';
    pluralName: 'prod-layouts';
    displayName: 'Prod Layout';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    options: Attribute.Component<'options.options'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
